...
var SabreError = function (returnedCode, errorData, originalError) {
  if(this instanceof SabreError) {
    this.message = 'Sabre error';
    this.httpCode = returnedCode;
    this.errorData = errorData;
    this.originalError = originalError;
    this.stack = Error().stack;
  }else{
    return new SabreError(returnedCode,errorData,originalError)
  }

}
SabreError.prototype = Object.create(Error.prototype);
SabreError.prototype.name = "SabreError";
        ...
        oauth2.getOAuthAccessToken(
            ...
            function (error, access_token) {
              if (error) {
                ...
                var err = new SabreError(error.statusCode, error_data, error);
                log.error('Error:', err);
                cb(err, null, null);
              } else {
