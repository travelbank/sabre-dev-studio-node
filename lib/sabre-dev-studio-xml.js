...
var SabreDevStudioXml = ( function() {
  function SabreDevStudioXml( options ){
     ...
     *   startDate: string, Date which they'll be starting their stay (required, format: 'mm-dd')
     *   endDate: string, Date which they'll be ending their stay (required, format: 'mm-dd')
